---
title: "Classifier round 1 - summarize with ChatGPT"
author: "O'Hara"
format: 
  html:
    code-fold: true
...
```{r}
files_df <- read_csv(here('_data/5c_classifier_round1/int/fulltext_files.csv'))
...
out_f <- here('_output/phase3_classifier/chatgpt_summary.csv')
