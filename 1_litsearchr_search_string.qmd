...
bib_clean_fs <- list.files(here('bibtex_clean'), pattern = 'wosnaive_', full.names = TRUE)
...
* societal value - value clause AND social, ecological, economic clause
    * Value context (all connected with OR)
        ...
        * "benefit" (+651)
        * "utility" (+413)
        * _maybe "quality" (+3577) or "assess*" (+7792) or "evaluat*" (+5132)_ - NO, these blow it up too much
    * AND
    * Societal context (all connected with OR): 
        ...
        * _NASA Applied Science themes:_
        * "capacity building" (+6)
        * "disaster" (+185)
        * "water resource*" (+299)
