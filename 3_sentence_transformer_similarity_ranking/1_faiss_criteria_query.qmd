...
Having read in the indexed articles, let's process the distance for each criteria phrase across the entire corpus, and save out as .csv with article info and distance.
...
for term in term_list:
    ...
    f = os.path.join(OUT_DIR, 'faiss_out_' + term.replace(' ', '_') + '.csv')
    x.to_csv(f)
