---
title: "Sample 1000 - summarize with ChatGPT"
author: "O'Hara"
format: 
  html:
    code-fold: true
...
```{r}
files_df <- read_csv(here('_data/5b_sample_1000/int/fulltext_files.csv'))
...
out_f <- here('_output/phase2_sample_1000/chatgpt_summary.csv')

if(!file.exists(out_f)) {
  
  endpt <- 'https://api.openai.com/v1/chat/completions'
  
  prompt <- 'Summarize the methods of this paper, particularly methods used to estimate or quantify the societal benefits of satellite or Earth Observation data.'
