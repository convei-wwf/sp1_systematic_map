...
if(any(!file.exists(topic_outf, terms_outf))) {
  ...
  abstr_words_dtm <- cast_dtm(abstr_words_df, document = title, term = word, value = n)
  
  set.seed(4321)
  message('Processing the full abstract set of ', nrow(abstr_df), ' titles, with k = 25...')
