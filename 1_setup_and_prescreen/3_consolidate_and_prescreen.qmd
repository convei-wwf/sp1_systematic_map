...
Pull in all preprocessed citation data.  Identify duplicates by first author and title.  Save only one version (Societal Benefits $\succ$ Web of Science $\succ$ Scopus).  Also save out the benchmark documents, separately.
