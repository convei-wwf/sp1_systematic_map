...
```{r}
files_df <- read_csv(here('_data/5e_classifier_round3/int/fulltext_files.csv'))
...
out_f <- here('_output/phase5_classifier/chatgpt_summary.csv')
  ...
  for(i in 1:nrow(txt_df)) {
    ...
    post_body <- list(
      ...
      messages = list(
        ...
        list(role = 'system', content = 'You are a helpful research assistant with a background in economic and social science methods.'),
