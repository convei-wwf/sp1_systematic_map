...
Examining missed sources (Sept 27):

* Missing a "value" clause term: Angelstam, Charreire, Haas, Kalluri, Mathai, Pettorelli (x2)
    * assess? quality? analyze/analysis, evaluate? utility? natural capital?
* Missing a "social" clause term: Eom
* Not in WoS database: Druckenmiller (white paper/grey lit?), Cooke, Lombardo, Reid