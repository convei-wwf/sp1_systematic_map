...
Load the articles and the results of the LDA on topics.  J
...
top_tf_idf_by_topic <- value_bigram_tf_idf %>%
  ...
  select(doc_id, topic, word, bigram_freq, idf, tf_idf)
...
top_tf_idf_by_topic <- value_trigram_tf_idf %>%
  ...
  select(doc_id, topic, word, trigram_freq, idf, tf_idf)
