...
links_long <- screen_df %>%
  mutate(colandr  = case_when(colandr == 'check' ~ 'Title/abstract exclude (n =  200)',
                              colandr == 'include' ~ 'Title/abstract include (n =  770)',
                              colandr == 'exclude' ~ 'Title/abstract exclude (n = 2,854)',
