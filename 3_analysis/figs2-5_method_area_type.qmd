...
val_type_df <- includes_df %>%
  ...
  ### replace "eudaimonistic" with combined "social-relational"
  mutate(val_type = str_replace(value_type_arias_arevalo, 'eudaimonistic', 'social-relational')) %>%
  ### then check Himes categories; if any "relational" append "social-relational" to val_type
  mutate(val_type = ifelse(str_detect(value_type_himes, 'relational'),
                           paste(val_type, 'social-relational', sep = ';'),
                           val_type)) %>%
  select(key, val_type) %>%
...
ggsave('fig2_method_by_value.png', height = 3.5, width = 6, dpi = 300)

knitr::include_graphics('fig2_method_by_value.png')
```
...
f2_plot <- ggdraw() +
  ...
  draw_label('n = 54', x = 0.845, y = 0.695, size = 6, 
             hjust = 1, vjust = 1) +
  draw_label('Instrumental\n(monetary)', x = 0.813, y = 0.72, size = 6, 
             hjust = 1, vjust = 0) +
  draw_label('Instrumental\n(non-monetary) ', x = 0.8750, y = 0.72, size = 6, 
             hjust = 0, vjust = 0) +
  draw_label('Social-relational',   x = 0.875, y = 0.68, size = 6, 
             hjust = 0, vjust = 1) +
  draw_label('Value type',   x = 0.85, y = 0.8, size = 8, fontface = 'bold',
             hjust = .5, vjust = 0)
  
ggsave('fig3_multimethod.png', height = 3.5, width = 6, dpi = 300)

knitr::include_graphics('fig3_multimethod.png')
...
ggsave('fig4_sba_by_value.png', height = 3, width = 6, dpi = 300)

knitr::include_graphics('fig4_sba_by_value.png')
...
ggsave('fig5_multicontext.png', height = 3, width = 5, dpi = 300)

knitr::include_graphics('fig5_multicontext.png')
