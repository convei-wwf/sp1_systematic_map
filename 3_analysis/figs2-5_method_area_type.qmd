...
f2_plot <- ggdraw() +
  ...
  draw_label('n total', x = 0.845, y = 0.695, size = 6, 
             hjust = 1, vjust = 1) +
  draw_label('Instrumental\n($) (n = 48)', x = 0.813, y = 0.72, size = 6, 
             hjust = 1, vjust = 0) +
  draw_label('Instrumental\n(non-$) (n = 24)', x = 0.8750, y = 0.72, size = 6, 
             hjust = 0, vjust = 0) +
  draw_label('Social-relational\n(n = 7)',   x = 0.875, y = 0.68, size = 6, 
             hjust = 0, vjust = 1) +
...
f4_plot <- ggdraw() +
  ...
  draw_label('n total', x = 0.845, y = 0.695, size = 6, 
             hjust = 1, vjust = 1) +
  draw_label('Instrumental\n($) (n = 38)', x = 0.813, y = 0.72, size = 6, 
             hjust = 1, vjust = 0) +
  draw_label('Instrumental\n(non-$) (n = 20)', x = 0.8750, y = 0.72, size = 6, 
             hjust = 0, vjust = 0) +
  draw_label('Social-relational\n(n = 10)',   x = 0.875, y = 0.68, size = 6, 
             hjust = 0, vjust = 1) +
  draw_label('Value type',   x = 0.85, y = 0.8, size = 8, fontface = 'bold',
             hjust = .5, vjust = 0)
